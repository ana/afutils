...
class Probe:
    ...
    If given an afutils.ssh.Session object representing another machine, Probe
...
def detect(session=None):
    ...
    If given an afutils.ssh.Session object, it will attempt to detect the
    distro of another machine via an ssh connection.

    :param session: ssh connection between another machine
    :type session: afutils.ssh.Session
